...
Bridge.assembly("MazeGuy", function ($asm, globals) {
    ...
    Bridge.define("MazeGuy.Game1", {
        ...
        ctors: {
            ...
            ctor: function () {
                ...
                var look = System.IO.FileShim.ReadAllLines("../Maze.txt");
                this.WIDTH = look[System.Array.index(0, look)].length;
        ...
        methods: {
            ...
            Eqiuvalent: function (c, x, y) {
                try {
                    ...
                    if (Bridge.is($e1, System.IndexOutOfRangeException)) {
            ...
            Die: function (gameTime) {
                var $t, $t1;
                System.Windows.Forms.MessageBox.Show("You Lost MazeGuy!", "MazeGuy", System.Windows.Forms.MessageBoxButtons.OK);
                var result = System.Windows.Forms.MessageBox.Show("Would you like to restart?", "MazeGuy", System.Windows.Forms.MessageBoxButtons.YesNo);
                if (result === System.Windows.Forms.DialogResult.Yes) {
                    new MazeGuy.Game1().Run();
                } else {
                    ...
                    if (result === System.Windows.Forms.DialogResult.Yes) {
                        if (System.IO.FileShim.Exists("../Maze " + this.level + ".txt")) {
                            this.stepSize = 0.2;
                            this.on_a_step = false;
                            this.on_the_wall = false;
                            var look = System.IO.FileShim.ReadAllLines("../Maze " + this.level + ".txt");
                            this.WIDTH = look[System.Array.index(0, look)].length;
                            this.HEIGHT = look.length;
                            this.maze = System.Array.create(0, null, MazeGuy.TileType, this.WIDTH, this.HEIGHT);
                            var y = 0;
            ...
            LoadContent: function () {
                ...
                var iceTex = this.Content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, "ice");
            ...
            Update: function (gameTime) {
                ...
                if (MazeGuy.Extension.WasKeyJustPressed(state, Microsoft.Xna.Framework.Input.Keys.Left, this.oldState.$clone())) {
                    newPos.X--;
                }
                if (MazeGuy.Extension.WasKeyJustPressed(state, Microsoft.Xna.Framework.Input.Keys.Right, this.oldState.$clone())) {
                    newPos.X++;
                }
                if (MazeGuy.Extension.WasKeyJustPressed(state, Microsoft.Xna.Framework.Input.Keys.Up, this.oldState.$clone())) {
                    newPos.Y--;
                }
                if (MazeGuy.Extension.WasKeyJustPressed(state, Microsoft.Xna.Framework.Input.Keys.Down, this.oldState.$clone())) {
                    newPos.Y++;
                }
                try {
                    ...
                    if (this.on_a_step) {
                        ...
                        if (newTile === MazeGuy.TileType.Ice) {
                            ...
                            } else if (this.manPos.X < 0) {
                                this.manPos.X = 0;
                            } else if (this.manPos.Y > this.HEIGHT) {
                                this.manPos.Y = (this.HEIGHT - 1) | 0;
                            } else if (this.manPos.Y < 0) {
                                this.manPos.Y = 0;
                            }
                        } else if (newTile === MazeGuy.TileType.Exit) {
                            this.won = true;
                        ...
                        } else if (newTile === MazeGuy.TileType.KillingFloor || newTile === MazeGuy.TileType.KillingStep || newTile === MazeGuy.TileType.Pit || newTile === MazeGuy.TileType.Floor || newTile === MazeGuy.TileType.KillingStep) {
                            this.Die(gameTime);
                        } else {
                            this.manPos = newPos.$clone();
                        }
                    ...
                    if (Bridge.is($e2, System.IndexOutOfRangeException)) {
                    } else {
                        throw $e2;
                    }
                }
            ...
            Draw: function (gameTime) {
                ...
                if (!this.won && !this.start) {
                    ...
                    if (System.IO.FileShim.Exists("../Maze " + this.level + ".txt")) {
                        ...
                        this.spriteBatch.DrawString(this.font, "Congratulations! Yow Won!", new Microsoft.Xna.Framework.Vector2.$ctor2(300, 300), Microsoft.Xna.Framework.Color.Gold.$clone());
                    }

                } else {
                    this.spriteBatch.DrawString(this.font, "You didn't choose a start!", new Microsoft.Xna.Framework.Vector2.$ctor2(300, 300), Microsoft.Xna.Framework.Color.Gold.$clone());
                }
    ...
    Bridge.define("System.IO.FileShim", {
        statics: {
            methods: {
                Exists: function (path) {
                    var level = System.IO.FileShim.ParseLevelFromPath(path);
                    return System.Nullable.hasValue(level) && MazeGuy.Game1.Levels.containsKey(System.Nullable.getValue(level));
                },
                ReadAllLines: function (path) {
                    var level = System.IO.FileShim.ParseLevelFromPath(path);
                    if (System.Nullable.hasValue(level) && MazeGuy.Game1.Levels.containsKey(System.Nullable.getValue(level))) {
                        return MazeGuy.Game1.Levels.getItem(System.Nullable.getValue(level));
                    }
                    return System.Array.init(0, null, System.String);
                },
                ParseLevelFromPath: function (path) {
                    // Handle "../Maze.txt" -> level 2 (original level 1 was broken - no exit)
                    if (System.String.contains(path,"Maze.txt") && !System.String.contains(path,"Maze ")) {
                        return 2;
                    }

                    // Handle "../Maze 2.txt" -> level 2, etc.
                    var start = (System.String.indexOf(path, "Maze ") + 5) | 0;
                    if (start < 5) {
                        return null;
                    }

                    var end = System.String.indexOf(path, ".txt");
                    if (end < 0) {
                        return null;
                    }

                    var numStr = path.substr(start, ((end - start) | 0));
                    var level = { };
                    if (System.Int32.tryParse(numStr, level)) {
                        return level.v;
                    }
            ...
            methods: {
                Show: function (text, caption, buttons) {
                    if (buttons === System.Windows.Forms.MessageBoxButtons.YesNo) {
                        return Bridge.global.confirm(text) ? System.Windows.Forms.DialogResult.Yes : System.Windows.Forms.DialogResult.No;
                    } else {
                        Bridge.global.alert(text);
